...
run_comprehensive_cv_comparison <- function(user_item_matrix, n_folds = 5, optimal_params) {
  ...
  # User-Based CF
    ubcf_cv <- cross_validate_ubcf(user_item_matrix_ubcf, n_folds = 5, k = 50)
  all_results[2, ] <- list(
    "User-Based CF",
  ...
  # Item-Based CF
    ibcf_cv <- cross_validate_ibcf(user_item_matrix_ibcf, n_folds = 5, k = 50)
  all_results[1, ] <- list(
    "Item-Based CF",
  ...
  # Neural Network
  nn_cv <- cross_validate_h2o(user_item_matrix_nn, n_folds = 5, optimal_params = optimal_params)
  all_results[4, ] <- list(
    "Neural Network",
