...
# Report results (commented out to avoid console output in PDF)
...
# Verify no duplicates remain (commented out to avoid console output in PDF)
...
kable(book_popularity_summary, 
      format = "latex",
      booktabs = TRUE,
      caption = "Book Popularity Distribution",
      align = c("l", "c")) %>%
  kable_styling(
    latex_options = c("HOLD_position", "scale_down"),
    font_size = 10
...
kable(sparsity_summary, 
      format = "latex",
      booktabs = TRUE,
      caption = "Dataset Sparsity Analysis",
      align = c("l", "c")) %>%
  kable_styling(
    latex_options = c("HOLD_position", "scale_down"),
    font_size = 10
