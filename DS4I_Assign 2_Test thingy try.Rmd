...
cross_validate_h2o <- function(user_item_matrix, n_folds = 3, 
  ...
  # Assume H2O is already initialized outside this function
  h2o.no_progress()
...
```{r run-cv-comparison}
# Initialize once before running any cross-validation
h2o.init(nthreads = -1, max_mem_size = "4G")
h2o.no_progress()

# Run all cross-validations (including Neural Network)
ibcf_cv <- cross_validate_ibcf(unified_matrix)
ubcf_cv <- cross_validate_ubcf(unified_matrix)
mf_cv <- cross_validate_mf(unified_matrix)
nn_cv <- cross_validate_h2o(unified_matrix)

# Shut down after everything is done
